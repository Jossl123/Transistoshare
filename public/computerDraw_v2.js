function add_input_point() {
    ...
    <div id="${current_road.length}" l="1" name="" class="z-20 flex inline-flex items-center">
...
function add_output_point() {
    ...
    <div action="" class="z-20 flex inline-flex items-center">
        <button type="i" onclick="link_output(event)" class="h-4 w-4 z-20 focus:outline-none rounded-full bg-white"></button>
        <button value="0" class="h-8 w-8 my-1 z-20 focus:outline-none rounded-full bg-white"></button>
    </div>`
}
