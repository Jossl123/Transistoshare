...
function update() {
    for (let i = 0; i < userData.transistors.length; i++) {
        var checked = ""
        var t = userData.transistors[i]
        if (t.creator == t.property) {
            if (t.public) checked = "checked"
            document.getElementById("transistors").innerHTML +=
                ...
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">${t.description}</p>
                <div class="flex">
                    <p>public</p>
